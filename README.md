...
class types like `SplFixedArray`. I've got this solution down to 2 seconds using 458mb of RAM. (_using a standard `array`
takes 3.7 seconds however it only uses 240mb of RAM_)
![day 15 part 2](/aoc-2020-jthatch-day15-pt2.png "AOC 2020 PHP Day 15 Part 2 in 2 secs")
